...
tinymce.addI18n("nb_NO", {
  ...
  "ID should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.":
    "ID må starte med bokstav, fulgt av nummer, skråstreker, punktum, kolon eller understrek",
  ...
  "Find (if searchreplace plugin activated)":
    "Finn (dersom tillegg for s\xf8k og erstatt er aktivert)",
  ...
  "Row clipboard actions": "Handlinger for rad utklippstavle",
  "Column clipboard actions": "Handlinger for kolonne utklippstavle",
  "Table styles": "Tabell stiler",
  "Cell styles": "Celle stiler",
  "Column header": "Kolonne stiler",
  "Row header": "Radoverskrift",
  "Table caption": "Tabelltekst",
  Caption: "Bildetekst",
  ...
  Scope: "Omfang",
  Alignment: "Justering",
  "Horizontal align": "Horisontalt justert",
  "Vertical align": "Vertikalt justert",
  Top: "Topp",
  Middle: "Sentrert",
  Bottom: "Bunn",
  ...
  "To open the popup, press Shift+Enter":
    "For \xe5 \xe5pne popup, trykk Shift+Enter",
  "Rich Text Area": "Rik tekst område",
  "Rich Text Area. Press ALT-0 for help.":
    "Rik-tekstomr\xe5de. Trykk ALT-0 for hjelp.",
  ...
  "Could not load emojis": "Kunne ikke laste emojier",
  People: "Mennesker",
  ...
  "Invalid hex color code: {0}": "Ikke gyldig hex fargekode",
  "Invalid input": "Ugyldig input",
  R: "R",
  "Red component": "Rød komponent",
  G: "G",
  "Green component": "Grønn komponent",
  B: "B",
  "Blue component": "Blå komponent",
  "#": "#",
  "Hex color code": "Hex fargekode",
  "Range 0 to 255": "Fra 0 til 255",
  Turquoise: "Turkis",
  Green: "Gr\xf8nn",
  Blue: "Bl\xe5",
  Purple: "Lilla",
  ...
  "Open popup menu for split buttons":
    "\xc5pne sprettoppmeny for splitt-knapper",
  "List Properties": "Listeegenskaper",
  "List properties...": "Listeegenskaper ...",
  "Start list at number": "Start liste p\xe5 nummer",
  "Line height": "Linjeh\xf8yde",
  "Dropped file type is not supported": "Kastet fil, filtype støttes ikke",
  "Loading...": "Laster",
